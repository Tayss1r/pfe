      ...
      <div className="w-full max-w-lg">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Equipment Manager</h1>
            <p className="text-gray-600 dark:text-gray-400">Technician Dashboard & Equipment Tracking</p>
          </div>
          ...
          {isAuthenticated && user ? (
            ...
            <div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-4 text-center">Features</h3>
                <ul className="space-y-3">
                  {[
                    { icon: '🔍', text: 'Search Equipment by serial, client, brand' },
                    { icon: '📚', text: 'Access technical documentation' },
                    { icon: '📧', text: 'Contact manufacturers & clients' },
                    { icon: '🔧', text: 'View spare parts inventory' },
                  ].map((feature, i) => (
